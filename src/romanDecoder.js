...
//expressing each decimal digit of the number 
...
function solution(roman) {
    ...
    return roman
      ...
      .reduceRight((result, currentSymbol, index, arr) => {
        ...
        const nextValue = romanNumerals[arr[index + 1]] || 0;
  
        return currentValue < nextValue ? result - currentValue : result + currentValue;
      }, 0);
  }
